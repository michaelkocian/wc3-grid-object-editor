...
export const abilityCodes = {
    ...
    Aap5: "Aura - Plague (Animated Dead)",
    ...
    Afrb: "Frost Breath",
    Afrc: "Frost Breath (new, has icon)",
    ...
    AIhw: "Healing Ward",
    AIsw: "Sentry Ward (Item)",
    AIil: "ItemIllusion        ",
    AIv1: "ItemInvis (Lesser)",
    AIv2: "ItemInvis (Greater)",
    AIvu: "ItemInvul (Normal)",
    AIvl: "ItemInvul (Lesser)",
    AIvg: "ItemInvul (Divinity)",
    ...
    AIg2: "ItemRitualDagger (Regen)",
    AIf2: "Orb of Fire v2",
    Ahsb: "Sundering Blades",
    APai: "PassiveSimple",
    Ahri: "Passive - human rifleman plus range (Rhri)",
    Ahan: "Passive - human animal breeding (Rhan)",
    Ahpe: "Passive - phoenix (Fire and Egg)",
    Ahlh: "Passive - human lumber harvesting (Rhlh)",
    Aobs: "Passive - orc grunt berserk (Robs)",
    Aobk: "Passive - orc berserkers (Robk)",
    Aorb: "Passive - orc reinforced defense (Rorb)",
    Aosp: "Passive - orc spiked barricade (Rosp)",
    Aoth: "Passive - orc Ghost(icon only, orc, Aeth, unused)",
    Aotr: "Passive - orc troll regeneration (Rotr)",
    Augf: "Passive - undead ghoul frenzy (Rugf)",
    Augh: "Passive - Ghost (icon only, undead, Agho)",
    Ausm: "Passive - undead skeletal mastery (Rusm)",
    Aeib: "Passive - nightelf improved bows (Reib)",
    Aemk: "Passive - nightelf marksmanship (Remk)",
    Aews: "Passive - nightelf well spring (Rews)",
    AIbd: "FigurineBlueDrake",
    AIut: "FigurineFurbolgTracker",
    AIes: "FigurineDragonspawnOverseer",
    AIts: "ItemTransmute",
