...
export const SUBROW_ALWAYS_VISIBLE_COLUMNS = {
  ...
  abilities: ['atp1', 'aub1', 'aut1','auu1','amcs', 'atar', 'adur'],
};
...
export const GRID_COLUMNS = {
  items: [
    ...
    'ubpx','ubpy','ufoo','uhot','isit','ureq','urqa','utip','utub',
  ],
  abilities: [
  ...
  units: [
    ...
    'uabt','uacq','uaen','ualp','uamn','uani','uarm','ides','ubba','uhas',
    'ubdg','ubdi','uble','ubpx','ubpy','ubpr','ubs1','ubs2','ubsi',
    'ucam','ucar','ucbs','uclb','uclg','uclr','ucol','ucpt','ucs1','ucs2','ucua',
    'ucun','ucut','udaa','udea','udef','udep','udl1','udl2','udp1','udp2','udro',
    'udtm','udty','udu1','udu2','udup','uept','uerd','ufle','ufoo','ufor',
    'ufrd','ugol','ugor','uhom','uhos','uhot','uhpm','uhpr','uhrt','uico','uimz','uine','uisz',
    'ulba','ulbd','ulbs','ulev','ulfi','ulfo','ulos','ulpx','ulpy','ulpz','ulsz',
    'ulum','ulur','uma1','uma2','umas','upor','umdl','umh1','umh2','umis','ubui',
    'umpi','umpm','umpr','umsl','umvf','umvh','umvr','umvs','umvt','umxp','umxr',
    'unsf','uocc','uori','upoi','upri','ushb','uhd1','uhd2',
    'uprw','upgr','uqd1','uqd2','urac','urb1','urb2','ureq',
    'urpg','urpo','urpp','urpr','urqa','urtm','urun','ursl',
    'usca','uscb','usd1','usd2','usei','useu','usew','ushh','ushr','ushu','ushw','ushx',
    'ushy','usid','usin','usle','uslz','usma','usit','usnd','uspa','uspe','usr1',
    'usr2','usrg','ussc','ussi','usst','utaa','utar','utc1','utc2',
    'utcc','utco','util','utip','utss','utub','utyp',
    'uuch','uver','uwal','uwu1','uwu2','unbs','ufma',
  ],
  unitheroes: [
    'unam','ua1b','ua1c','ua1d','ua1f','ua1g','ua1h','ua1m','ua1p','ua1q','ua1r',
    'ua1s','ua1t','ua1w','ua1z','ua2b','ua2c','ua2d','ua2f','ua2g','ua2h','ua2m',
    ...
    'ubdg','ubdi','uble','ubpx','ubpy','ubpr','ubs1','ubs2','ubsi','ubui',
    'ucam','ucar','ucbs','uclb','uclg','uclr','ucol','ucpt','ucs1','ucs2',
    'udaa','udea','udef','udep','udl1','udl2','udp1','udp2','udro',
    'udtm','udty','udu1','udu2','udup','uept','uerd','ufoo','ufor',
    'ufrd','ugol','ugor','uhab','uhas','uhd1','uhd2','uhhb','uhhd','uhhm','uhom',
    'uhos','uhot','uhpm','uhpr','uhrt','uico','uimz','uine','uinp','uint','uisz',
    'ulba','ulbd','ulbs','ulev','ulfi','usnd','ursl','ulfo','ulos','ulpx','ulpy','ulpz','ulsz',
    'ulum','ulur','uma1','uma2','umas','upor','umdl','umh1','umh2','umis',
    'umpi','umpm','umpr','umsl','umvf','umvh','umvr','umvs','umvt','umxp','umxr',
    'unsf','uocc','uori','upoi','upra','upri','upro','ufma',
    'uprw','upru','upgr','uqd1','uqd2','urac','urb1','urb2','ureq',
    'urpg','urpo','urpp','urpr','urtm','urun','urva','usca','uscb',
    'usd1','usd2','usei','useu','usew','ushh','ushr','ushb','ushw','ushx',
    'ushy','usid','usin','usle','uslz','usma','usit','uspa','uspe','usr1',
    'usr2','usrg','ussc','ussi','usst','ustp','ustr','utaa','utar','utc1','utc2',
    'utcc','utco','util','utip','utpr','utra','utss','utub','utyp','ufle','ubld',
    'uuch','uver','uwal','uwu1','uwu2','unbs',
    'urqa','urq1','urq2','urq3','urq4','urq5','urq6','urq7','urq8','ides','ushu','urqc',
  ],
  unitbuildings: [
    "udaa","uhas","uabi","uabs","utcc","uble","ucbs","ucpt","urun","uwal","ubpx",
    "ubpy","udtm","uept","uerd","ufrd","ubbs","uico","ussi","umxp","umxr","umdl",
    "uver","uocc","uori","upor","uimz","uisz","ulpx","ulpy","ulpz","ulsz","uprw",
    "uani","ualp","ubpr","uscb","usca","uslz","usew","ussc","ushu","ushx","ushy",
    "ushh","ushw","ushb","ushv","uspa","utaa","uclg","uclb","ufat","uacq","uarm",
    "ubs1","ua1b","udh1","uqc1","udl1","ua1d","ua1f","ua1h","ua1q","ua1p","ua1c",
    "ua1s","ua1t","ua1w","ua1z","ua2b","ua2c","ua2d","ua2f","ua2g","ua2h","ua2m",
    "ua2p","ua2q","ua2r","ua2s","ua2t","ua2w","ua2z","uaap","uabr","uabt","uaen",
    "uamn","ubba","ubdg","ubdi","ubld","ubs2","ubsi","ubui","ucam","ucar","ua1r",
    "uclr","ucol","ucs1","ucs2","ides","udea","udef","udep","udl2","udp1",'ubsl',
    "udp2","udro","udty","udu1","udu2","udup","ufle","ufma","ufoo","ufor","ugol",
    "ugor","uhom","uhos","uhot","uhpm","uhpr","uhrt","uine","ulba","ulbd","ulbs",
    "ulev","ulfi","ulfo","ulos","ulum","ulur","uma1","uma2","umas","umh1","umh2",
    "umis","umki","umpi","umpm","umpr","umsl","umvf","umvh","umvr","umvs","umvt",
    "unsf","upap","upar","upat","upaw","upoi","upri","upgr","uqd1","uqd2","urac",
    "urb1","urb2","ureq","ures","urev","urqa","urtm",'uhd1','uhd2','ua1m',"ua1g",
    "ursl","usd1","usd2","usei","useu","ushr","usid","usin","usle","usma","usit",
    "usnd","uspe","usr1","usr2","usrg","usst","utar","utc1","utc2","utco","util",
    "utip","utss","utub","utyp","uubs","uuch","uupt","uwu1","uwu2","unbr",
    "unbs"
  ],
  buffs: [
  ...
  destructables: [
    ...
    'buch','bumm','busr','bvar','bvcb','bvcg','bvcr','bwal','bsnd',
  ],
  doodads: [
